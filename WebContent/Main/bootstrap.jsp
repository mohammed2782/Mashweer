...
if (sessionRQS.getAttribute("lu")!=null){
	...
	Myglobals.smartyGlobalsAssArr.put("globallogincompid",user.getCompID());
...
<head>
 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta charset="utf-8">
    <link rel="icon" href="../smartyresources/img/logo_xxxsm.png" type="image/png" /> 
    
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <title>مشاوير - البصرة</title>
    ...
    <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <img  src='../smartyresources/img/logo_sm.png' class='img-responsive' /> 
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                out.print(MenuBean.loadMenu(mainProjectPath, currentPage));
               	if (!MenuBean.isPermissionToViewCurrentPage()){
               		// kick out
