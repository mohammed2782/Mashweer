...
/**
 * Servlet implementation class TLKMultiRowsSpecialCasesBarCode
 */
@WebServlet("/TLKMultiRowsSpecialCasesBarCode")
public class TLKMultiRowsSpecialCasesBarCode extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TLKMultiRowsSpecialCasesBarCode() {
        super();
