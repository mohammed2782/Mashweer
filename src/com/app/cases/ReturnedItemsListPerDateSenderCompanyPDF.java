...
public class ReturnedItemsListPerDateSenderCompanyPDF {
	...
	public void prepareDocument(String c_company_sender, String ctxPath , String rtnDate) {
		...
		try {
			conn = mysql.getConn();
			cpb =  ut.getSenderCompanyReturnedItems(conn, c_company_sender, rtnDate);
