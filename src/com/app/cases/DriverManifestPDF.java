...
public class DriverManifestPDF {
	...
	public void prepareDocument(  String driverId, String stgCode, String stpCode, String storeCode, String fromdt, String todt, String ctxPath) {
		...
		try {
	        ...
	        PdfPCell cell;
	        par = new Paragraph("مندوب التوصيل :  "+ut.getDriverName(conn, driverId),font);
	        ...
	        table = getManifestTable(conn, driverId , stgCode , stpCode, storeCode, fromdt, todt ,font);
	        document.add(table);
	...
	private  PdfPTable getManifestTable(Connection conn , String driverId, String stgCode, String stpCode,  String storeCode, 
			String fromdt, String todt, Font font){
        ...
        try{
	        ...
	        relativeWidths [1] = 8; // fragile, color red
	        relativeWidths [2] = 4; // qty
	        relativeWidths [3] = 18; // rmk
	        relativeWidths [4] = 12; // hp
	        relativeWidths [5] = 6; // rcv name
	       
	        relativeWidths [6] = 17; // address
	        relativeWidths [7] = 12; // amount to collect
	        relativeWidths [8] = 7; // receipt no ori
	        relativeWidths [9] = 13; // sender company
	        relativeWidths [10] = 13; // sender name
			...
			/*
			ph = new Phrase("تسليم مبلغ",font);
			cell = new PdfPCell(ph);
			cell.setBackgroundColor(BaseColor.LIGHT_GRAY);
			cell.setPaddingBottom(5);
			table.addCell(cell);
			
			ph = new Phrase("إرجاع مواد",font);
			cell = new PdfPCell(ph);
			cell.setBackgroundColor(BaseColor.LIGHT_GRAY);
			cell.setPaddingBottom(5);
			table.addCell(cell);
			*/
			ph = new Phrase("قابل للكسر",font);
			cell = new PdfPCell(ph);
			cell.setBackgroundColor(BaseColor.LIGHT_GRAY);
			cell.setPaddingBottom(5);
			table.addCell(cell);
        	...
        	for (CaseInformation ci  : dlvs){
				...
				if (ci.getFragile().equalsIgnoreCase("Y")) {
