...
public class ReturnedItemsListPerDatePDF {
	...
	public void prepareDocument(  int custId, String ctxPath , String branchCode, String rtnDate) {
		...
		try {
			conn = mysql.getConn();
			cpb =  ut.getCustomerReturnedItems(conn, custId, branchCode, rtnDate);
