...
public class CoreMgr {
	 ...
	 */
	protected HashMap <String , String>   userDefinedFilterLookups;
	protected HashMap <String , String>   userDefinedMinDateSelect;
	protected HashMap <String , String>   userDefinedMaxDateSelect;
	...
	public CoreMgr(){
		...
		userDefinedMinDateSelect		= new HashMap<String ,String>(); 
		userDefinedMaxDateSelect		= new HashMap<String ,String>();
	...
	public StringBuilder DisplayFilters(){
		if (canFilter){
			return myhtmlmgr.genrateFilter(userDefinedFilterCols    , userDefinedColLabel,
										  ...
										  allSqlColsTypes			, userDefinedMinDateSelect  , 
					...
					if (!userModifiedTD) {
						if (userDefinedEditCols.contains(key) && allowEdit && canEdit){
							...
							gridHtml.append("<td>"+myhtmlmgr.GetHtmlInput(
														   ...
														   true						 , i	  , 
														   userDefinedMinDateSelect  , userDefinedMaxDateSelect)+"</td>");
						}else{
