...
public class HTMLmgr {
	...
	private String normalBGColor   = "white";
	...
	public StringBuilder getCaptionTableAndHeaders(String userDefinedCaption 		, String userDefinedCapationWithOutHtml, boolean canEdit, 
			   ...
			   int userDefinedPageRows){
				...
				+ "<div class='x_panel "+userDefined_x_panelclass+"'>"
					+ "<div class='x_title'>"
						+ "<ul class='nav navbar-right col-md-8'><li><h5>"+userDefinedCaption+"</h5></li></ul>"
				...
				if (isExport){ //editable grid is a porblem as it will make form inside form so we seperate it in another function
				...
				if (editableGrid) {
					view.append("<li><form name=\""+myClassBean+"\" action='?myClassBean="+myClassBean+"&upd=1' method='POST' "+UserDefindEditFormEnctype+"> \n");//Form
					view.append("<button type='submit' style ='margin-left:20px;padding:10px;margin-top:0px;' class='fa fa-save fa-lg' value='save'/></li>");
				}
	...
	public StringBuilder genrateFilter(ArrayList<String>userDefinedFilterCols, 
								...
								HashMap<String,String> userDefinedMinDateSelect  , 
								HashMap<String,String> userDefinedMaxDateSelect
								){
		...
		for (String key :userDefinedFilterCols)
			{  	
			    ...
			    InnerFilterHtml.append( GetHtmlInput(userDefinedFilterColsHtmlType, lookupMapVal 		, key,
			    									   ...
			    									   false					    , null				, required,
			    									   false						, 0					, userDefinedMinDateSelect  , 
			    									   userDefinedMaxDateSelect));
	...
	public StringBuilder GetHtmlInput(HashMap <String , String > userDefinedColsHtmlType , 
			LinkedHashMap<String , LinkedHashMap<String , String>> colMapValues,
				...
				HtmlInputConfig htmlInputConfig = new HtmlInputConfig();
				htmlInputConfig.setUserDefinedMaxDateSelect(userDefinedMaxDateSelect);
				htmlInputConfig.setUserDefinedMinDateSelect(userDefinedMinDateSelect);
				htmlInputConfig.setMultiEdit(multiEdit);
				htmlInputConfig.setRequired(required);
				htmlInputConfig.setHidden(hidden);
				htmlInputConfig.setDisabled_attr(disabled);
				htmlInputConfig.setBGcolor(BGcolor);
				return shape.getHtmlInput(sqlColsSizes,userDefinedColsHtmlType, colMapValues, defValue, Readonly, htmlInputConfig );
		    }
} 
