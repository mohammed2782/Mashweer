...
public class AdvancedPaymentRecieptPDF {
	...
	public void prepareDocument(  int advpmt_id, String ctxPath) {
		this.ctxPath = ctxPath;
		String imgPath = ctxPath+"/smartyresources/img/logo_xsm.png";
		docsDir = ctxPath+"/"+"PDFDocs";
		fileName= "smarty_advpmt"+docExtension;
		...
		try {
			conn = mysql.getConn();
			cpb =  ut.getAdvancedPaymentOfCustomer(conn, advpmt_id);
	       ...
	       // ct.addElement(par);
	        ...
	        BaseColor bc = new BaseColor(165, 126, 2); 
            ...
            par = new Paragraph("دفع مقدم",font4);
	        cell = new PdfPCell(par);
 			cell.setBackgroundColor(bc);
 			cell.setPadding(5);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
            ...
            par = new Paragraph("إيصال دفع مقدم رقم: ",font2);
	        cell = new PdfPCell(par);
	        cell.setPadding(5);
 			cell.setBackgroundColor(bc);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
 			...
 			cell.setBorder(cell.NO_BORDER);
            table.addCell(cell);
            par = new Paragraph(""+advpmt_id,font3);
	        cell = new PdfPCell(par);
	        cell.setPadding(5);
 			cell.setBackgroundColor(bc);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
	...
	private  PdfPTable getShipmentsTable(Connection conn ,CustomerPaymentBean cpb,Font font){
        ...
        try{
	        ...
	        relativeWidths [3] = 7; // net
	        relativeWidths [4] = 8; // shipment cost
	        relativeWidths [5] = 8; // receipt amt
	        relativeWidths [6] = 14; // hp
	        relativeWidths [7] = 13; // address
	        relativeWidths [8] = 10; // receipt no 
            ...
            BaseColor bcOdd = new BaseColor(255,255,229); 
        	...
        	BaseColor bcTotal = new BaseColor(165, 126, 2);
        	...
        	ph = new Phrase("المبلغ  المقدم للعميل",fontTotal);
			cell = new PdfPCell(ph);
			cell.setPaddingBottom(10);
