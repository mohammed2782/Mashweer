...
public class AgentsPayments extends CoreMgr{
		public AgentsPayments() {
			MainSql = "select ap_id,ap_agentid, ap_amount_paid, ap_paymentdt, ap_createdby, ap_rmk, ap_barcode, '' as fake, "
					+ " (ap_createddt + INTERVAL 9 HOUR) as ap_createddt from p_agent_payments where ap_agentid={agentAcct} and ap_barcode='N' "
					+ " order by ap_id desc ";
			...
			userDefinedGridCols.add("ap_createddt");
			...
			userDefinedColLabel.put("ap_createddt", "تاريخ الدفع الفعلي");
