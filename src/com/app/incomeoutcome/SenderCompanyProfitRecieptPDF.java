...
public class SenderCompanyProfitRecieptPDF {
	...
	boolean newPage = true;
	 ...
	 int center = 0;
	 int rural = 0;
	 double amtShipmentprofit = 0;
	 double amtPartnershare = 0;
	...
	public void prepareDocument(  int senderCompanyPmtId, String ctxPath) {
		...
		try {
	        ...
	        Paragraph par = new Paragraph("حساب الشريك",font4);
	       ...
	       // ct.addElement(par);
	        ...
	        par = new Paragraph("الشركة المرسلة: ",font2);
            ...
            par = new Paragraph("حساب شركة التوصيل",font4);
	        cell = new PdfPCell(par);
 			cell.setBackgroundColor(bc);
 			cell.setPadding(5);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
            ...
            par = new Paragraph("شحنات المركز",font2);
	        cell = new PdfPCell(par);
	        cell.setPadding(5);
 			cell.setBackgroundColor(bc);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
            ...
            par = new Paragraph("شحنات الأطراف",font2);
	        cell = new PdfPCell(par);
	        cell.setPadding(5);
 			cell.setBackgroundColor(bc);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
            ...
            par = new Paragraph("الربح الكلي",font2);
	        cell = new PdfPCell(par);
	        cell.setPadding(5);
 			cell.setBackgroundColor(bc);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
            ...
            par = new Paragraph(""+numFormat.format(amtShipmentprofit),font3);
	        cell = new PdfPCell(par);
	        cell.setPadding(5);
 			cell.setBackgroundColor(bc);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
            ...
            par = new Paragraph("حصة الشريك",font2);
	        cell = new PdfPCell(par);
	        cell.setPadding(5);
 			cell.setBackgroundColor(bc);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
            ...
            par = new Paragraph(""+numFormat.format(amtPartnershare),font3);
	        cell = new PdfPCell(par);
	        cell.setPadding(5);
 			cell.setBackgroundColor(bc);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
	...
	private  PdfPTable getShipmentsTable(Connection conn ,PickUpAgentPaymentBean papb,Font font){
        ...
        try{
	        ...
	        relativeWidths [4] = 7; //shipment profit
	        relativeWidths [5] = 7; //partner share
	        relativeWidths [6] = 8; // net amt
	        relativeWidths [7] = 7; // shipment cost
	        relativeWidths [8] = 8; // receipt amt
	        relativeWidths [9] = 13; // rcv ph
	        //relativeWidths[8] = 11; // cust name
	        relativeWidths [10] = 15; // address
	        //relativeWidths [11] = 6; // rural
	        relativeWidths [11] = 9; // cust name
	        relativeWidths [12] = 7; // receipt no 
	        relativeWidths [13] = 4; // seq
	        ...
	        headers.add("الصافي");
	        headers.add("الربح الكلي");
	        headers.add("حصة الشريك");
	        headers.add("الحاله");
	        headers.add("عدد");
        	...
        	for (CaseInformation ci  : shipments){
				...
				/*if(ci.getRural().equalsIgnoreCase("Y"))
					ph = new Phrase("نعم",font);
				else
					ph = new Phrase("لا",font);
				cell = new PdfPCell(ph);
				cell.setPaddingBottom(10);
				cell.setBackgroundColor(bc);
				table.addCell(cell);*/
				...
				//shipment profit
				ph = new Phrase(numFormat.format(ci.getShipmentprofit()),font);
				cell = new PdfPCell(ph);
				cell.setPaddingBottom(10);
				cell.setBackgroundColor(bc);
				table.addCell(cell);
				
				amtShipmentprofit += ci.getShipmentprofit();
				//partner share
				ph = new Phrase(numFormat.format(ci.getPartnershare()),font);
				cell = new PdfPCell(ph);
				cell.setPaddingBottom(10);
				cell.setBackgroundColor(bc);
				table.addCell(cell);
				amtPartnershare += ci.getPartnershare();
				//status
				if(ci.getStatus().equalsIgnoreCase("dlv"))
					if(ci.getChangedPrice().equalsIgnoreCase("Y") && ci.getReceiptAmtB4Change() != ci.getReceiptAmt())
						ph = new Phrase("تم التسليم مع تغيير مبلغ الوصل من "+numFormat.format((int)ci.getReceiptAmtB4Change())+" "
								+ "الى "+numFormat.format((int)ci.getReceiptAmt()),font);
					else
						ph = new Phrase("تم التسليم",font);
				
				else if (ci.getStatus().equalsIgnoreCase("canceled") && ci.getShipmentChargesPaidByCustomer().equalsIgnoreCase("Y"))
					ph = new Phrase("راجع مع دفع مبلغ توصيل من المستلم ومبلغ الوصل هو المبلغ المستلم",font);
				else
					ph = new Phrase("ERROR",font);
				cell = new PdfPCell(ph);
				cell.setPaddingBottom(10);
        	...
        	ph = new Phrase("المبلغ الصافي",fontTotal);
			cell = new PdfPCell(ph);
			cell.setPaddingBottom(10);
        	...
        	ph = new Phrase("الربح الكلي",fontTotal);
			cell = new PdfPCell(ph);
			cell.setPaddingBottom(10);
			cell.setVerticalAlignment(Element.ALIGN_CENTER);
 			cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			...
			ph = new Phrase(numFormat.format(amtShipmentprofit),fontTotal);
			cell = new PdfPCell(ph);
			cell.setPaddingBottom(10);
			cell.setVerticalAlignment(Element.ALIGN_CENTER);
 			cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        	...
        	ph = new Phrase("حصة الشريك",fontTotal);
			cell = new PdfPCell(ph);
			cell.setPaddingBottom(10);
			cell.setVerticalAlignment(Element.ALIGN_CENTER);
 			cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			...
			ph = new Phrase(numFormat.format(amtPartnershare),fontTotal);
			cell = new PdfPCell(ph);
			cell.setPaddingBottom(10);
			cell.setVerticalAlignment(Element.ALIGN_CENTER);
 			cell.setHorizontalAlignment(Element.ALIGN_CENTER);
