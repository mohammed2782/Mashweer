...
public class CustomerPaymentsInAdvance extends CoreMgr {

	public CustomerPaymentsInAdvance() {
		...
		MainSql = " select advpmt_id ,advpmt_custid,advpmt_amt ,advpmt_date , advpmt_createdby ,advpmt_rmk, '' as fake "
				+ " from  p_inadvance_cust_pmt  where advpmt_custid = '{customerAcct}' order by advpmt_id desc ";
	...
	public String doDelete(HttpServletRequest rqs) {
		...
		try {
			...
			pst = conn.prepareStatement("insert into  p_deletedinadvance_payment_cases (dpc_dpid , dpc_cid, dpc_createdby) "
					+ " select c_advancepmtid , c_id , ? from p_cases where c_advancepmtid =?");
			...
			pst = conn.prepareStatement("insert into p_inadvance_cust_pmt_deleted "
					+ " 	(advpmt_id, advpmt_custid,advpmt_amt , advpmt_date, advpmt_rmk, advpmt_createddt, advpmt_createdby, advpmt_deletedby)" + 
					" SELECT advpmt_id, advpmt_custid,advpmt_amt , advpmt_date, advpmt_rmk, advpmt_createddt, advpmt_createdby, ?  "
