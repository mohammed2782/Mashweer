...
public class PickUpAgentPaymentRecieptPDF {
	...
	public void prepareDocument(  int pickUpAgentPmtId, String ctxPath) {
		...
		try {
			conn = mysql.getConn();
			papb =  ut.getPickUpAgentPaymentInfo(conn, pickUpAgentPmtId);
	        ...
	        Paragraph par = new Paragraph("حساب مندوب الإستلام",font4);
	       ...
	       // ct.addElement(par);
	        ...
	        par = new Paragraph("مندوب الإستلام: ",font2);
            ...
            par = new Paragraph("حساب مندوب الإستلام",font4);
	        cell = new PdfPCell(par);
 			cell.setBackgroundColor(bc);
 			cell.setPadding(5);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
	        ...
	        cell.setPadding(5);
 			...
 			cell.setBorder(cell.NO_BORDER);
            table.addCell(cell);
            par = new Paragraph(""+pickUpAgentPmtId,font3);
	        cell = new PdfPCell(par);
	        cell.setPadding(5);
 			cell.setBackgroundColor(bc);
 			cell.setVerticalAlignment(Element.ALIGN_LEFT);
	...
	private  PdfPTable getShipmentsTable(Connection conn ,PickUpAgentPaymentBean papb,Font font){
        ...
        try{
	        ...
	        relativeWidths [7] = 15; // rcv number
        	...
        	ph = new Phrase("المبلغ الصافي لمندوب الإستلام",fontTotal);
			cell = new PdfPCell(ph);
			cell.setPaddingBottom(10);
