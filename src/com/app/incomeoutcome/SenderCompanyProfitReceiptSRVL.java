...
/**
 * Servlet implementation class SenderCompanyProfitReceiptSRVL
 */
@WebServlet("/SenderCompanyProfitReceiptSRVL")
public class SenderCompanyProfitReceiptSRVL extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SenderCompanyProfitReceiptSRVL() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String docType = "pdf";
			SenderCompanyProfitRecieptPDF pdfRs =  new SenderCompanyProfitRecieptPDF();
			String contentType = "application/pdf";
			
			response.setContentType(contentType);
			String fileName = "sendercompanyprofitreciept_"+cppc_id+"_.pdf"; 
	...
	public File getFileExported(SenderCompanyProfitRecieptPDF pdfRs , int cp_id, String ctxPath){
