...
public class AgentPaymentRecieptPDF {
	...
	private  PdfPTable getShipmentsTable(Connection conn ,AgentPaymentBean apb,Font font){
        ...
        try{
	        ...
	        relativeWidths [3] = 11; // city
	        relativeWidths [4] = 15; // cust name
	        relativeWidths [5] = 7; // receipt no
	        relativeWidths [6] = 8; // date 
	        relativeWidths [7] = 10; // date 
        	...
        	double amountToBeCollectedFromAgent = totalChargeCount  - agentChargesCount;
